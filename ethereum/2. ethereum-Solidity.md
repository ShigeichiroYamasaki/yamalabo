...
ここでは、Ethereum のノードとネットワークとしてgeth、Ropstenテストネットを想定します。

[Ethereum Ropsten ノード構築](https://github.com/ShigeichiroYamasaki/yamalabo/blob/master/ethereum/ethereum-Ropsten.md)
...
例：複数のユーザーで１つの整数値を登録・更新するスマートコントラクト
...
* プラグマ：pragma solidity >=0.4.16 <0.9.0;
* contract　宣言：スマートコントラクトの名前とデータと関数の定義
* 変数宣言：uint storedData;
* 関数定義 get, set

### solc でSolidityプログラムをコンパイルしてみる

solc コマンドに --abi と --bin オプションをつける
...
別のターミナルを開き
geth上の JavaScript プロンプトでコンパイル結果を変数に格納する
（Macの場合は、シェルを bashに切り替えておく）
...
```
> let bin ="0x"+""
```
...
```
> let myContract = contract.new({ from: eth.accounts[0], data: bin})
