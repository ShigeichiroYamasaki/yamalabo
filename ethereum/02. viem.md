...
viem は，大きく分けると Client と Transport の2つ部分から構成されています．Client は，EVM クライアントに対する API を介した操作を行うためのもので，Transport は，操作を実施するための通信手段で，http や WebSocket などを指定します．

### Client

クライアントには，ublic Client，Wallet Client，Test Client の３つがあります．

* Public Client
  * ブロック番号やアカウントの残高の確認のような EVM 側の操作のためのクライアント
* Wallet Client
  * トランザクションへの署名や送出のようなワレット側の操作のためのクライアント
* Test Client
