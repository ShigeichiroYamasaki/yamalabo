...
2022/08/01 更新 Shigeichiro Yamasaki
...
* gethは実行クライアントです。
* コンセンサスクライアントには、PoW, PoA, PoS などがあります。
...
Ethereumのメインネットは、PoWからPoSに移行することが予定されています。
...
### Ropsten ネットワークの The Merge

Ethereumの main ネットワークは PoW から PoS に移行することが予定されています。
それにさきがけて、2022年6月2日にテストネットワークのRopstenが PoW から PoS に移行しました。
