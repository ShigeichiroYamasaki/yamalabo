...
▶ Create an empty hardhat.config.js を選択（キーボードの矢印キーを使って）
...
hardhat では chaiを Node.js のcommonJSモジュールとして import ではなく require で読み込む

ES6 モジュールかcommonJS モジュールかの区別は package.json で決定される
