...
=>
README.md  contracts  hardhat.config.js  ignition  node_modules  package-lock.json  package.json  test
```
...
* コンパイル結果はartifacts ディレクトリに格納されます

artifacts ディレクトリ以下を3階層まで木構造表示させる
