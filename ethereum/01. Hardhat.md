...
=>
  ...
  Tokenコントラクト
    ✔ Tokenの総量が owner に割り当てられていること (387ms)
    ✔ アカウント間でトークンが転送されること
...
* `Future` オブジェクトは，内部的なデプロイ実施方法の表現であって，ネットワークへの実際の作用は行いません．
