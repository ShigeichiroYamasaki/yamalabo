...
```bash
chmod 766 install-bitcoincore.sh
...
bitcoin-cli getnewaddress 'alice'
...
bitcoin-cli generatetoaddress 5 <自分のアドレス>

# 約17時間後　(100ブロック後）残高が増えていることを確認する
bitcoin-cli getbalance

# bobというラベルでアドレスを生成してみる
bitcoin-cli getnewaddress 'bob'
...
```bash
# 送金
bitcoin-cli sendtoaddress <送金先アドレス> 67
