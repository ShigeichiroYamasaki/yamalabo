...
# 送金
locked_tx, locked_txid, redeem_script = send_multisig(amount,m,pubkeys)
```
...
def unlock_p2sh(locked_txid, redeem_script, addr, key1, key2)
...
unlock_txid , unlock_tx = unlock_p2sh(locked_txid, redeem_script, erza, keyBob, keyCarol)
```
