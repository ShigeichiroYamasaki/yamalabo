...
2024/05/27  更新 Shigeichiro Yamasaki
...
## <a id="DESC"> descriptor ワレットの作成</a>

### UTXOの所有と discriptor

当初，ブロックチェーン上のデジタル資産であるUTXOの所有の概念は，当事者の秘密鍵を中心に構成されていました．
...
* Key Expression
    ...
    Script Expressionの引数としてよく使われる式に、Key Expression（KEYと表記）がある。これは公開鍵または秘密鍵と、オプションとしてその鍵のオリジンに関する情報を表す
...
* P2SH 2-of-3 Multisig output を表現する Descriptor の例
...
* P2WSH 2-of-3 Multisig output を表現する Descriptor の例
...
echo $PUBKEY1
=> 
"037032106297741808e66c947dab836f3f3c28189596331e48861304674e2583d0"
echo $PUBKEY2
=>
"0210c7796ac91075ff6d4708319094707a976d265263cac42cc535104803439f84"
echo $PUBKEY3
=>
"0359ee82a3b3ec86bc8c29c149cacde7af2e00cd8952ee5767d6c221a2807c4094"
```
...
echo P2SH_ADDR
=>
"2N9kJJFdQvdD1gYAuirNVNFvsZcFcKtULCS"
```
...
=>
"5221037032106297741808e66c947dab836f3f3c28189596331e48861304674e2583d0210210c7796ac91075ff6d4708319094707a976d265263cac42cc535104803439f84210359ee82a3b3ec86bc8c29c149cacde7af2e00cd8952ee5767d6c221a2807c409453ae"
```
...
echo $P2WSH_ADDR
=>
"tb1q5w03kkrvsr2nvgn6gqfgjqht3x6gghjstt3g7ez0cuvahnpe500svcyx4c"
```
...
```bash
P2TR_ADDR=`bitcoin-core.cli getnewaddress "" bech32m`

echo $P2TR_ADDR
=>
tb1pzwmas3lmkrn63wtgulylmtx79fvg3x5e0d6u9g50l3y8c3k0hvxqez8qxa
```
