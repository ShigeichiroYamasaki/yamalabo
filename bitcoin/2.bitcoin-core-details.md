...
2023/04/02 更新 Shigeichiro Yamasaki
...
0. 事前にsignetのfaucet から0.001 BTC ビットコインを得ておきます。

1. faucetから得たUTXOをinputとして5個のoutputを持つトランザクション (TX1) を作成し，署名して，ブロードキャストする

2. 5個のUTXOからそれぞれP2PK, P2PKH, P2SH, P2WPKH, P2WSH の５つのタイプのoutputを持つ5個のトランザクション(TX2 ~ TX6) を作成し，それぞれ署名して，ブロードキャストする
    3.1. P2PK のoutput を持つトランザクションの作成はバイナリ形式で作成する必要があります

3. 5個のタイプの異なるUTXOをinputとするトランザクション (TX7) を作成
...
```bash
bitcoin-core.cli -rpcwallet=<filename> getnewaddress
=>
...
この例では、"amount": 0.00100000　を持つUTXOを利用します

使用する"txid" と "vout"と "amount" の値をメモしてください
...
* output は、生成した5つのアドレスで、送金金額は、使用するUTXOのamountを5分割したうえで、一つの送金金額で手数料として0.002 程度減額した値にしてください。手数料はもっと小額でもかまいません。
...
=>
{
  ...
  "hash": "5517fb54842212d837da63465a3714e9774b689e0f0542f6773e07c653308693",
  "version": 2,
  "size": 315,
  "vsize": 234,
  "weight": 933,
  ...
  "vin": [
    {
      "txid": "4bb9ae7b7e7545618f0b711ff70ddf645d03ecedc1ebc7c952046afc94a2b649",
      "vout": 0,
      "scriptSig": {
        "asm": "",
        "hex": ""
      ...
      "txinwitness": [
        "30440220439a62facaaddfdbf7e7d653d0e17048a63ab914e6f9eb4b874f1e3d947ecf1902205da5ca369f4e5131cf9f2afdd7e263228246450c3bab8e90b9bd6527aa94fadc01",
        "032ec9fffcc63998f552bad82c9553550adcdedefb0906debb13a2a29d6712681b"
      ],
      "sequence": 4294967295
    }
  ],
  "vout": [
    {
      ...
      "n": 0,
      "scriptPubKey": {
        "asm": "0 b978ac2aca4dd091e8f1eae3263da9c4cdde306c",
        "desc": "addr(tb1qh9u2c2k2fhgfr683at3jv0dfcnxauvrv3mtnua)#84unm0fz",
        "hex": "0014b978ac2aca4dd091e8f1eae3263da9c4cdde306c",
    ...
    },
    {
      ...
      "n": 1,
      "scriptPubKey": {
        "asm": "0 96c4de6b6d2e8c2a44b7a2cc609e68a2244b9f11",
        "desc": "addr(tb1qjmzdu6md96xz539h5txxp8ng5gjyh8c33p460w)#q7lu8cxx",
        "hex": "001496c4de6b6d2e8c2a44b7a2cc609e68a2244b9f11",
    ...
    },
    {
      ...
      "n": 2,
      "scriptPubKey": {
        "asm": "0 42bbafc76463bc506aef03bb205bfda2729e3093",
        "desc": "addr(tb1qg2a6l3myvw79q6h0qwajqkla5fefuvynv9h89e)#7tpg6e3x",
        "hex": "001442bbafc76463bc506aef03bb205bfda2729e3093",
    ...
    },
    {
      ...
      "n": 3,
      "scriptPubKey": {
        "asm": "0 100787634975cb60a0912a1944607da80a7765e7",
        "desc": "addr(tb1qzqrcwc6fwh9kpgy39gv5gcra4q98we08vt43nl)#8llh3vch",
        "hex": "0014100787634975cb60a0912a1944607da80a7765e7",
    ...
    },
    {
      ...
      "n": 4,
      "scriptPubKey": {
        "asm": "0 6eb8c36e9b1ab1c9c8b39ae950d5c5cb59dbe7c0",
        "desc": "addr(tb1qd6uvxm5mr2cunj9nnt54p4w9edvahe7qnlpdyd)#x8ahmcea",
        "hex": "00146eb8c36e9b1ab1c9c8b39ae950d5c5cb59dbe7c0",
...
```bash
bitcoin-core.cli sendrawtransaction 
...
base52アドレスの場合（実際は３名で個別に行ってください）
...
その署名のためには、署名者のワレットにredeemScriptなどの必要な情報を組み込む必要があります。descriptor　は、ワレットにマルチシグ署名のための情報を組み込むためのデータです。
...
Bech32アドレスの場合（実際は３名で個別に行ってください）
...
https://github-com.translate.goog/ShigeichiroYamasaki/yamalabo/blob/master/bitcoin/2.bitcoin-core-details.md?_x_tr_sl=ja&_x_tr_tl=en&_x_tr_hl=ja&_x_tr_pto=wapp
