...
```bash
bob1=`bitcoin-core.cli -rpcwallet=bob getnewaddress`
...
★ ワレットが複数存在している場合は ` -rpcwallet=<ワレット名>` を追加してワレット名を指定してください
...
=>
{
  "address": "tb1qztkxahtzfpajx8sxxrs80skemuspfq78860j0j",
  "scriptPubKey": "001412ec6edd62487b231e0630e077c2d9df201483c7",
  "ismine": true,
  "solvable": true,
  "desc": "wpkh([9278fcb8/84h/1h/0h/0/17]039da07bde986db4b029581f8e082e84c01dc5897e6875a5213d4755755c555847)#we43jzn9",
  ...
  "iswitness": true,
  "witness_version": 0,
  "witness_program": "12ec6edd62487b231e0630e077c2d9df201483c7",
  "pubkey": "039da07bde986db4b029581f8e082e84c01dc5897e6875a5213d4755755c555847",
  "ischange": false,
  "timestamp": 1747385736,
  "hdkeypath": "m/84h/1h/0h/0/17",
...
```bash
# 実行例
alice1=`bitcoin-core.cli -rpcwallet=alice getnewaddress`
```
* 送金金額：0.0005

```bash
# 実行例
bitcoin-core.cli -rpcwallet=bob sendtoaddress $alice1 0.0005
...
```bash
bitcoin-core.cli  -rpcwallet=bob listtransactions
