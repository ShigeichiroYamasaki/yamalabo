...
```bash
bitcoin-core.cli -rpcwallet=alice getaddressinfo <ビットコインアドレス>
bitcoin-core.cli -rpcwallet=alice getaddressinfo tb1qfdmuhak44h3akp0dx6q5qpytuta6e6888mjlw4
```
...
```bash
dumpprivkey -rpcwallet=alice <ビットコインアドレス>
```

```bash
# 実行例
bitcoin-core.cli -rpcwallet=alice dumpprivkey tb1qgf02pn7fzaq0aknvq640j9gqc9td8p3cw47wj8

cRhNRAqnnX6rBRgDNnXP1vuNq8zAYRZA7wW5xLq1oJ6jpnSLnuwY
```
...
```bash
# 実行例
bitcoin-core.cli -rpcwallet=alice sendtoaddress tb1qfdmuhak44h3akp0dx6q5qpytuta6e6888mjlw4 0.01
