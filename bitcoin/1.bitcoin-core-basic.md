...
```bash
# myaddr1 の場合
bitcoin-core.cli  -rpcwallet="alice" getnewaddress myaddr1
...
```bash
# 実行例
bitcoin-core.cli -rpcwallet=alice getaddressinfo tb1q80pa4rrsv3vk7mg6uvm5gm5vsdzzy2ukl8n5v6
=>
{
...
```bash
# 実行例
bitcoin-core.cli -rpcwallet=alice getbalance
...
```bash
# 実行例
bitcoin-core.cli -rpcwallet=alice getnewaddress myaddr2
# 生成されたアドレスの例￼
tb1qfdmuhak44h3akp0dx6q5qpytuta6e6888mjlw4  
```
...
```bash
# 実行例
bitcoin-core.cli -rpcwallet=alice sendtoaddress tb1qfdmuhak44h3akp0dx6q5qpytuta6e6888mjlw4 0.001
...
```bash
bitcoin-core.cli -rpcwallet=alice listunspent
...
```bash
bitcoin-core.cli -rpcwallet=alice getrawtransaction 50dc0800c8421355e4bb719320f0216e5ac5ff21ed93bf06bf5ec2ec3a859fb5
=>
...
```bash
bitcoin-core.cli -rpcwallet=alice decoderawtransaction 
...
```bash
bitcoin-core.cli -rpcwallet=alice getnewaddress myaddr3
tb1qj0596apwztduay0ktk6lnhxxcumfz6mnnsykm3

bitcoin-core.cli -rpcwallet=alice getnewaddress myaddr4
...
```bash
bitcoin-core.cli -rpcwallet=alice createrawtransaction  '[{"txid":"50dc0800c8421355e4bb719320f0216e5ac5ff21ed93bf06bf5ec2ec3a859fb5","vout":0}]' '[{"tb1qj0596apwztduay0ktk6lnhxxcumfz6mnnsykm3":0.001}, {"tb1qc0xxe80njvjxdf26prp2gluth0ge3840dvensy":0.08898818}]'
=>
...
```bash
bitcoin-core.cli -rpcwallet=alice decoderawtransaction 0200000001b59f853aecc25ebf06bf93ed21ffc55a6e21f0209371bbe4551342c80008dc500000000000ffffffff02a08601000000000016001493e85d742e12dbce91f65db5f9dcc6c736916b7302c9870000000000160014c3cc6c9df3932466a55a08c2a47f8bbbd1989eaf00000000
=>
{
...
```bash
bitcoin-core.cli -rpcwallet=alice signrawtransactionwithwallet 0200000001b59f853aecc25ebf06bf93ed21ffc55a6e21f0209371bbe4551342c80008dc500000000000ffffffff02a08601000000000016001493e85d742e12dbce91f65db5f9dcc6c736916b7302c9870000000000160014c3cc6c9df3932466a55a08c2a47f8bbbd1989eaf00000000
=>
{
...
```bash
# 実行例
bitcoin-core.cli -rpcwallet=alice decoderawtransaction  
=>
{
  "txid": "a017b4f40f002e46a8bdc0749d8b4bf95e347f47f0341e08b89b5f14d18280fc",
...
```bash
bitcoin-core.cli -rpcwallet=alice sendrawtransaction 
=>
...
```bash
bitcoin-core.cli -rpcwallet=alice testmempoolaccept  '[""]'
=>
[
  {
...
```bash
bitcoin-core.cli -rpcwallet=alice getrawmempool
=>
[
